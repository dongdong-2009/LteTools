...
namespace Lte.Evaluations.Test.Parameters
{
    ...
    {
        protected IEnumerable<Town> towns = new List<Town>{
        ...
        protected IEnumerable<OptimizeRegion> regions = new List<OptimizeRegion>{
        ...
        protected IEnumerable<ENodeb> eNodebs = new List<ENodeb> {
        ...
        protected IEnumerable<ENodeb> lotsOfENodebs = new List<ENodeb> {
            new ENodeb { TownId = 1, ENodebId = 1, Name = "ENodeb-1", Address = "Address-1" },
            new ENodeb { TownId = 1, ENodebId = 2, Name = "ENodeb-2", Address = "Address-2" },
            new ENodeb { TownId = 2, ENodebId = 3, Name = "ENodeb-3", Address = "Address-3" },
            new ENodeb { TownId = 3, ENodebId = 4, Name = "ENodeb-4", Address = "Address-4" },
